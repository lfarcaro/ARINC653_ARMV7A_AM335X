...
// Vector table
static portUINTBASE PORT_VECTORTABLE[PORT_VECTORTABLE_SIZE] = {
...
static portBOOLEAN PORT_PREPAREGLOBALFLTRANSLATIONTABLE(unsigned int **PTR_FLTRANSLATIONTABLE) {
	SYSTEM_CONFIGURATION_TYPE *SYSTEM_CONFIGURATION;
	PORT_SYSTEM_CONFIGURATION_TYPE *PORT_SYSTEM_CONFIGURATION;
	unsigned int UINT_ACCESS;
	...
	// Sets access
	UINT_ACCESS = MMU_ACCESS_PL1_RO_PL0_NO; // Exceptions run in any context

	// Verifies access
	if (UINT_ACCESS != null) {

		// Maps vector table region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PORT_SYSTEM_CONFIGURATION->VECTORTABLE_ADDRESS, (unsigned int) ((unsigned int) PORT_SYSTEM_CONFIGURATION->VECTORTABLE_ADDRESS + PORT_SYSTEM_CONFIGURATION->VECTORTABLE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
...
static portBOOLEAN PORT_PREPARENONGLOBALFLTRANSLATIONTABLE(unsigned int **PTR_FLTRANSLATIONTABLE, unsigned int UINT_CONTEXT, PARTITION_INFORMATION_TYPE *CONTEXT_PARTITION_INFORMATION, PROCESS_INFORMATION_TYPE *CONTEXT_PROCESS_INFORMATION) {
	SYSTEM_CONFIGURATION_TYPE *SYSTEM_CONFIGURATION;
	PORT_SYSTEM_CONFIGURATION_TYPE *PORT_SYSTEM_CONFIGURATION;
	...
	// Sets access
	UINT_ACCESS = MMU_ACCESS_PL1_RW_PL0_NO | MMU_ACCESS_EXECUTENEVER; // Exceptions run in system stack
	switch (UINT_CONTEXT) {
	case CONTEXT_MODULEDEFAULTPARTITION:
		// Module default partition runs in system stack
	...
	if (UINT_ACCESS != null) {
		...
		// Maps system stack region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) SYSTEM_CONFIGURATION->SYSTEM_STACK_ADDRESS, (unsigned int) ((unsigned int) SYSTEM_CONFIGURATION->SYSTEM_STACK_ADDRESS + SYSTEM_CONFIGURATION->SYSTEM_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) SYSTEM_CONFIGURATION->SYSTEM_CODE_ADDRESS, (unsigned int) ((unsigned int) SYSTEM_CONFIGURATION->SYSTEM_CODE_ADDRESS + SYSTEM_CONFIGURATION->SYSTEM_CODE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) SYSTEM_CONFIGURATION->SYSTEM_DATA_ADDRESS, (unsigned int) ((unsigned int) SYSTEM_CONFIGURATION->SYSTEM_DATA_ADDRESS + SYSTEM_CONFIGURATION->SYSTEM_DATA_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps system heap region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) SYSTEM_CONFIGURATION->SYSTEM_HEAP_ADDRESS, (unsigned int) ((unsigned int) SYSTEM_CONFIGURATION->SYSTEM_HEAP_ADDRESS + SYSTEM_CONFIGURATION->SYSTEM_HEAP_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps system FL translation table region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_FLTRANSLATIONTABLE_ADDRESS, (unsigned int) ((unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_FLTRANSLATIONTABLE_ADDRESS + PORT_SYSTEM_CONFIGURATION->SYSTEM_FLTRANSLATIONTABLE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps system SL translation table region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_SLTRANSLATIONTABLE_ADDRESS, (unsigned int) ((unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_SLTRANSLATIONTABLE_ADDRESS + PORT_SYSTEM_CONFIGURATION->SYSTEM_SLTRANSLATIONTABLE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) MODULE_CONFIGURATION->MODULE_CODE_ADDRESS, (unsigned int) ((unsigned int) MODULE_CONFIGURATION->MODULE_CODE_ADDRESS + MODULE_CONFIGURATION->MODULE_CODE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) MODULE_CONFIGURATION->MODULE_DATA_ADDRESS, (unsigned int) ((unsigned int) MODULE_CONFIGURATION->MODULE_DATA_ADDRESS + MODULE_CONFIGURATION->MODULE_DATA_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS != null) {
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS, (unsigned int) ((unsigned int) MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS + MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
	}
	...
	for (PARTITIONINDEX = 0; PARTITIONINDEX < MODULE_CONFIGURATION->PARTITION_CONFIGURATION_SIZE; PARTITIONINDEX++) {
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_CODE_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_CODE_ADDRESS + PARTITION_CONFIGURATION->PARTITION_CODE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_DATA_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_DATA_ADDRESS + PARTITION_CONFIGURATION->PARTITION_DATA_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_ADDRESS + PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_HEAP_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_HEAP_ADDRESS + PARTITION_CONFIGURATION->PARTITION_HEAP_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_ADDRESS + PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (PARTITION_CONFIGURATION->PARTITION_ERRORHANDLER_STACK_ADDRESS != null) {
			...
			if (UINT_ACCESS != null) {
				...
				if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_ERRORHANDLER_STACK_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_ERRORHANDLER_STACK_ADDRESS + PARTITION_CONFIGURATION->PARTITION_ERRORHANDLER_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
					return false;
				}
			}
		}
		...
		if (PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS != null) {
			...
			if (UINT_ACCESS != null) {
				...
				if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS, (unsigned int) ((unsigned int) PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS + PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
					return false;
				}
			}
		}
		...
		for (PROCESSINDEX = 0; PROCESSINDEX < PARTITION_CONFIGURATION->PROCESS_CONFIGURATION_SIZE; PROCESSINDEX++) {
			...
			if (UINT_ACCESS != null) {
				...
				if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (unsigned int) PROCESS_CONFIGURATION->PROCESS_STACK_ADDRESS, (unsigned int) ((unsigned int) PROCESS_CONFIGURATION->PROCESS_STACK_ADDRESS + PROCESS_CONFIGURATION->PROCESS_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_NONSECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
					return false;
				}
			}
		}
...
portBOOLEAN PORT_HOOK_BEFORE_STARTUP_SYSTEM(void) {
	...
	VECTORTABLESOURCE = (portUINTBASE *) PORT_VECTORTABLE;
	VECTORTABLEDESTINATION = (portUINTBASE *) PORT_VECTORTABLE_ADDRESS;
	...
	CP15VectorBaseAddrSet(PORT_VECTORTABLE_ADDRESS);

	// Initializes UART console
	ConsoleUtilsInit();

	// Selects console type
	...
	MMU_STARTUP((unsigned int *) PORT_SYSTEM_CONFIGURATION->SYSTEM_FLTRANSLATIONTABLE_ADDRESS, (unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_FLTRANSLATIONTABLE_SIZE, (unsigned int *) PORT_SYSTEM_CONFIGURATION->SYSTEM_SLTRANSLATIONTABLE_ADDRESS, (unsigned int) PORT_SYSTEM_CONFIGURATION->SYSTEM_SLTRANSLATIONTABLE_SIZE);
...
portBOOLEAN PORT_HOOK_AFTER_STARTUP_SYSTEM(void) {
	PORT_SYSTEM_CONFIGURATION_TYPE *PORT_SYSTEM_CONFIGURATION;
	unsigned int *PTR_FLTRANSLATIONTABLE;
	...
	// Prepares global FL translation table
	{
		...
		// Gets system global FL translation table address
		PTR_FLTRANSLATIONTABLE = PORT_SYSTEM_CONFIGURATION->SYSTEM_GLOBAL_FLTRANSLATIONTABLE_ADDRESS;
		...
		// Sets system global FL translation table address
		PORT_SYSTEM_CONFIGURATION->SYSTEM_GLOBAL_FLTRANSLATIONTABLE_ADDRESS = PTR_FLTRANSLATIONTABLE;
	}
...
portBOOLEAN PORT_HOOK_AFTER_STARTUP_MODULE(void) {
	...
	// Enables MMU
	MMU_ENABLE(0x1, PORT_SYSTEM_CONFIGURATION->SYSTEM_GLOBAL_FLTRANSLATIONTABLE_ADDRESS, ((PORT_CONTEXT_TYPE *) MODULE_INFORMATION.CONTEXT.PORT_CONTEXT)->FLTRANSLATIONTABLE_ADDRESS, MODULE_INFORMATION.CONTEXT.IDENTIFIER);
...
void PORT_INITIALIZETICK(void) {
	...
	IntRegister(SYS_INT_TINT2, PORT_TICK);
...
static void PORT_ABORTERRORHANDLER_GETFAULTSTATUS(unsigned int FS, BOOLEAN_TYPE IN_STACK_AREA, ERROR_IDENTIFIER_TYPE *ERROR_IDENTIFIER, ERROR_CODE_TYPE *ERROR_CODE, MESSAGE_ADDR_TYPE *MESSAGE_ADDR, MESSAGE_SIZE_TYPE *MESSAGE_SIZE) {
	...
	case 15: //0b01111 - Permission fault, second level
		...
		*MESSAGE_SIZE = (IN_STACK_AREA ? 14 : 16);
		...
		if (IN_STACK_AREA) {
			ConsoleUtilsPrintf("Stack overflow (%u)", FS);
		} else {
			ConsoleUtilsPrintf("Memory violation (%u)", FS);
		}
#endif
		break;
	case 26: //0b11010 - Coprocessor abort
		...
		*MESSAGE_SIZE = 14;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("Hardware fault (%u)", FS);
#endif
		break;
	...
	case 20: //0b10100 - Lockdown
		...
		*MESSAGE_SIZE = 17;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("Translation fault (%u)", FS);
#endif
		break;
	case 1: //0b00001 - Alignment fault
		...
		*MESSAGE_SIZE = 22;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("Memory alignment fault (%u)", FS);
#endif
		break;
	...
	case 30: //0b11110 - Synchronous parity error on translation table walk, second level
		...
		*MESSAGE_SIZE = 19;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("Memory access fault (%u)", FS);
#endif
		break;
	case 4: //0b00100 - Fault on instruction cache maintenance
		...
		*MESSAGE_SIZE = 11;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("Cache fault (%u)", FS);
#endif
		break;
	default:
		...
		*MESSAGE_SIZE = 0;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		ConsoleUtilsPrintf("WARNING: Unhandled error (%u)", FS);
#endif
		break;
	}
}
...
void PORT_ABORTERRORHANDLER(unsigned int DFAR, unsigned int DFSR, unsigned int IFAR, unsigned int IFSR, unsigned int LR) {
	...
	ConsoleUtilsPrintf("Current context (%u): ", CURRENT_CONTEXT->IDENTIFIER);

	// Verifies current system state
	switch (CURRENT_CONTEXT->SYSTEM_STATE) {
	case SYSTEMSTATE_MODULEHEALTHMONITORINGCALLBACK:
		ConsoleUtilsPrintf("Module HM callback\n");
		break;
	case SYSTEMSTATE_MODULEDEFAULTPARTITION:
		ConsoleUtilsPrintf("Module default partition\n");
		break;
	case SYSTEMSTATE_MODULEIDLEPARTITION:
		ConsoleUtilsPrintf("Module idle partition\n");
		break;
	case SYSTEMSTATE_PARTITIONHEALTHMONITORINGCALLBACK:
		ConsoleUtilsPrintf("Partition HM callback\n");
		break;
	case SYSTEMSTATE_PARTITIONERRORHANDLER:
		ConsoleUtilsPrintf("Partition error handler\n");
		break;
	case SYSTEMSTATE_PARTITIONDEFAULTPROCESS:
		ConsoleUtilsPrintf("Partition default process\n");
		break;
	case SYSTEMSTATE_PARTITIONIDLEPROCESS:
		ConsoleUtilsPrintf("Partition idle process\n");
		break;
	case SYSTEMSTATE_PROCESS:
		ConsoleUtilsPrintf("Process\n");
		break;
	case SYSTEMSTATE_OPERATINGSYSTEM:
		ConsoleUtilsPrintf("Operating system\n");
		break;
	}
	...
	if (NEXT_CONTEXT != null) {
		...
		// Shows next context
		ConsoleUtilsPrintf("Next context (%u): ", NEXT_CONTEXT->IDENTIFIER);
	...
	IN_STACK_AREA = ((DFAR >= (unsigned int) ((PORT_MODULE_CONFIGURATION_TYPE *) MODULE_CONFIGURATION.PORT_MODULE_CONFIGURATION)->STACK_AREA_START_ADDRESS) && (DFAR < (unsigned int) ((PORT_MODULE_CONFIGURATION_TYPE *) MODULE_CONFIGURATION.PORT_MODULE_CONFIGURATION)->STACK_AREA_END_ADDRESS));
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		// Shows abort type
		ConsoleUtilsPrintf("Prefetch abort: ");
#endif
	...
	if (DFSR != null) {
		...
		if (WnR) {
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
			ConsoleUtilsPrintf(" while writing 0x%X, running at 0x%X\n", DFAR, LR);
#endif
		} else {
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
			ConsoleUtilsPrintf(" while reading 0x%X, running at 0x%X\n", DFAR, LR);
#endif
		}
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
	ConsoleUtilsPrintf("Undefined instruction (0x%X)\n", LR);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	ConsoleUtilsPrintf("System error: ");
	ConsoleUtilsPuts((char *) MESSAGE_ADDR, (int) LENGTH);
	ConsoleUtilsPrintf(", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	ConsoleUtilsPrintf("Module error: ");
	ConsoleUtilsPuts((char *) MESSAGE_ADDR, (int) LENGTH);
	ConsoleUtilsPrintf(", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	ConsoleUtilsPrintf("Partition error: ");
	ConsoleUtilsPuts((char *) MESSAGE_ADDR, (int) LENGTH);
	ConsoleUtilsPrintf(", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	ConsoleUtilsPrintf("Process error: ");
	ConsoleUtilsPuts((char *) MESSAGE_ADDR, (int) LENGTH);
	ConsoleUtilsPrintf(", system state %u, error identifier %u, error code %u, failed process %u, failed address 0x%X\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE, FAILED_PROCESS_ID, FAILED_ADDRESS);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	ConsoleUtilsPrintf("Application message: ");
	ConsoleUtilsPuts((char *) MESSAGE_ADDR, (int) LENGTH);
	ConsoleUtilsPrintf("\n");
#endif
}
