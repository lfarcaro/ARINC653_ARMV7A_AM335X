...
void STARTUP_MODULE(RETURN_CODE_TYPE *RETURN_CODE) {
	...
	MODULE_INFORMATION.MODULE_CONFIGURATION = &MODULE_CONFIGURATION;

	// Allocates memory for module partition information - Allocates even if pointer is not null
	HEAP_ALLOCATE(&SYSTEM_INFORMATION.REC_HEAP, (heapPOINTER *) &MODULE_INFORMATION.PARTITION_INFORMATION, sizeof(PARTITION_INFORMATION_TYPE) * MODULE_INFORMATION.MODULE_CONFIGURATION->MAXIMUM_PARTITION_COUNT, true);
	...
	HEAP_ALLOCATE(&SYSTEM_INFORMATION.REC_HEAP, (heapPOINTER *) &MODULE_INFORMATION.CONTEXT.PORT_CONTEXT, sizeof(PORT_CONTEXT_TYPE), false);
	...
	MODULE_INFORMATION.CONTEXT.IDENTIFIER = 1; // Reserved value
	...
	HEAP_ALLOCATE(&SYSTEM_INFORMATION.REC_HEAP, (heapPOINTER *) &MODULE_INFORMATION.HEALTHMONITORINGCALLBACK_INFORMATION.CONTEXT.PORT_CONTEXT, sizeof(PORT_CONTEXT_TYPE), false);
	...
	if (MODULE_CONFIGURATION_HEALTHMONITORING != null) {
		...
		if (MODULE_CONFIGURATION_HEALTHMONITORING->CALLBACK_ENTRY_POINT != null) {
			...
			if (MODULE_INFORMATION.HEALTHMONITORINGCALLBACK_INFORMATION.CONTEXT.IDENTIFIER == null) {
				MODULE_INFORMATION.HEALTHMONITORINGCALLBACK_INFORMATION.CONTEXT.IDENTIFIER = (SYSTEM_INFORMATION.NEXT_CONTEXT_IDENTIFIER++);
			}
