...
void INITIALIZE_MODULE_INFORMATION(void) {
	MODULE_INFORMATION_TYPE *MODULE_INFORMATION;
	IDENTIFIER_TYPE FIRST_CONTEXT_IDENTIFIER;
	IDENTIFIER_TYPE LAST_CONTEXT_IDENTIFIER;
	PARTITION_ID_TYPE PARTITION_IDENTIFIER;

	// Gets module information
	MODULE_INFORMATION = _CORE_MODULE_INFORMATION;

	// Gets the module's context identifier range
	PORT_GETCONTEXTIDENTIFIERRANGE(&FIRST_CONTEXT_IDENTIFIER, &LAST_CONTEXT_IDENTIFIER);

	// (Re)initializes information
	// MODULE_INFORMATION->MODULE_CONFIGURATION = null; // Must be already initialized
	MODULE_INFORMATION->NEXT_CONTEXT_IDENTIFIER = FIRST_CONTEXT_IDENTIFIER; // The first identifier is reserved for the module default partition context
	MODULE_INFORMATION->LAST_CONTEXT_IDENTIFIER = LAST_CONTEXT_IDENTIFIER; // Other identifiers are reserved for other modules' contexts
